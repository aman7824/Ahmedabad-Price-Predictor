...
- 🔘 User-friendly UI with dropdown inputs  
- 📊 Data visualization & analytics (charts)  
- 🤖 Advanced ML model (XGBoost / Linear Regression)  
...
## 🎯 Use Case
This project helps users, buyers, and real estate enthusiasts to estimate property prices in Ahmedabad based on real data.
